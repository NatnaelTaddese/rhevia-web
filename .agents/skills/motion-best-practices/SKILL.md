# motion by jezweb/claude-skills
...
**Error**: Exit animations don't play, components disappear instantly **Source**: [GitHub Issue #3078](https://github.com/motiondivision/motion/issues/3078)
...
**Error**: Reorder auto-scroll fails, doesn't work with Next.js routing **Source**: [GitHub Issue #3469](https://github.com/motiondivision/motion/issues/3469), #2183, #2101
...
**Error**: Drag gestures break when dragging from top to bottom in file trees **Source**: [GitHub Issue #3169](https://github.com/motiondivision/motion/issues/3169)
...
**Error**: Layout animations start from incorrect positions in scaled parent containers **Source**: [GitHub Issue #3356](https://github.com/motiondivision/motion/issues/3356)
...
**Error**: Exit state stuck when child unmounts during exit animation **Source**: [GitHub Issue #3243](https://github.com/motiondivision/motion/issues/3243)
...
**Error**: Layout animations teleport instantly instead of animating smoothly **Source**: [GitHub Issue #3401](https://github.com/motiondivision/motion/issues/3401)
...
**Error**: 1px layout shift just before exit transition starts **Source**: [GitHub Issue #3260](https://github.com/motiondivision/motion/issues/3260)
...
*   **Official Site**: [https://motion.dev](https://motion.dev/)
*   **React Docs**: [https://motion.dev/docs/react](https://motion.dev/docs/react)
*   **GitHub**: [https://github.com/motiondivision/motion](https://github.com/motiondivision/motion) (30,200+ stars)
*   **Examples**: [https://motion.dev/examples](https://motion.dev/examples) (300+ examples with source code)
*   **npm Package**: [https://www.npmjs.com/package/motion](https://www.npmjs.com/package/motion)
...
*   Open an issue: [https://github.com/jezweb/claude-skills/issues](https://github.com/jezweb/claude-skills/issues)
